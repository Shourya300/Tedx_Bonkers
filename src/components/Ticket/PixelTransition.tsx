...
const PixelTransition: React.FC<PixelTransitionProps> = ({
  ...
  const inactiveRef = useRef<HTMLDivElement | null>(null);
  ...
  const animatePixels = (activate: boolean): void => {
    ...
    if (!pixelGridEl || !activeEl || !inactiveEl) return;
  ...
  return (
    ...
    >
      ...
      <div ref={inactiveRef} className="absolute inset-0 w-full h-full" aria-hidden={isActive}>
        {firstContent}
      </div>
