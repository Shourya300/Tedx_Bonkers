  ...
  useEffect(() => {
    ...
    class App {
      constructor(container, options = {}) {
        ...
        // Adjust FOV and camera position for mobile devices
        const isMobile = window.innerWidth < 768;
        const adjustedFov = isMobile ? options.fov * 1.05 : options.fov;
        ...
        this.camera.position.z = isMobile ? -8 : -5;
        this.camera.position.y = isMobile ? 10 : 8;
