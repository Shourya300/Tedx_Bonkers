    ...
    <main className="relative min-h-screen w-full text-white font-sans selection:bg-[#B52D2D] selection:text-white overflow-x-hidden">
      ...
      >
        ...
        <motion.button
          ...
          className="absolute bottom-8 ml-[25%] md:ml-[45%] -translate-x-1/2 z-10 flex flex-col items-center gap-2 text-white/60 hover:text-white transition-colors group w-full max-w-[200px]"
