...
export default function Home() {
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    const calculateScrollMetrics = () => {
      ...
      const calculatedScrollDistance = effectiveScrollRange + vh * scrollMultiplier;
      ...
      const extraPadding = deviceType === 'mobile' 
        ? vh * 4  // Increased to allow full scroll to center
        : vh * 2.5; // Increased to allow full scroll to center
      const scrollDistance = Math.max(minScrollDistance, calculatedScrollDistance) + extraPadding;
